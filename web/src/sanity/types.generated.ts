...
export type Author = {
  ...
  republishConsent?: "na" | "granted" | "pending" | "declined";
};
...
// Query: *[_type == "author" && slug.current == $slug][0]{    name, "slug": slug.current, bio, role, institution, country, isStaff,    photo {   asset->{ _id, url, metadata { lqip, dimensions } },  alt,  caption,  credit,  hotspot,  crop },    socials[]{ platform, url }  }
